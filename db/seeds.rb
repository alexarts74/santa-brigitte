...
Room.create!(name: 'Room n°1', description: 'Très belle chambre au bord du lac avec lit double et petit déjeuner compris dans le prix', price: 40, user: brigitte)
room_image = Cloudinary::Uploader.upload(Rails.root.join("app/assets/images/chambre_1.jpeg"))
room.image.attach(io: URI.open(room_image['secure_url']), filename: "tshirt-tbmlover.jpeg", content_type: "image/jpeg")

Room.create!(name: 'Room n°2', description: 'Très belle chambre au bord du lac avec lit double et petit déjeuner compris dans le prix', price: 40, user: brigitte)
...
Room.create!(name: 'Room n°3', description: 'Très belle chambre au bord du lac avec lit double et petit déjeuner compris dans le prix', price: 40, user: brigitte)
...
Room.create!(name: 'Room n°4', description: 'Très belle chambre au bord du lac avec lit double et petit déjeuner compris dans le prix', price: 40, user: brigitte)
